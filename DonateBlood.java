    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            try {
                ...
                st.executeUpdate("INSERT into donateblood values ('"+name+"', '"+gender+"', '"+dob+"', '"+bldgrp+"', '"+disease+"', '"+city+"', '"+units+"', '"+mobile+"')");
                JOptionPane.showMessageDialog(rootPane,"Your Donation Request has been Submitted!","INSERTED",JOptionPane.WARNING_MESSAGE);
